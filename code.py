      ...
      if len(p_list) == 3:
        ...
        # Column B
          ...
          # Icon/Button B2
            ...
            kbd.send(Keycode.ALT, Keycode.F5)
          # Icon/Button B3 
          elif y > 175 and y < 225:
            kbd.send(Keycode.CONTROL,Keycode.SHIFT, Keycode.ALT ,Keycode.N)  
        ...
        # Column C
          ...
          # Icon/Button C3
            ...
            kbd.send(Keycode.CONTROL, Keycode.ALT,Keycode.SHIFT )  
        ...
        # Column D 
          ...
          # Icon/Button D2
            ...
            kbd.send(Keycode.SHIFT, Keycode.F5)
          # Icon/Button D3
          elif y > 175 and y < 225:
            kbd.send(Keycode.CONTROL, Keycode.ALT,Keycode.SHIFT )  
            time.sleep(.3)
